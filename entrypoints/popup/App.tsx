...
function App() {
	...
	// const [callbackTabId, setCallbackTabId] = useState<number | undefined>(
	// 	undefined,
	// );
	...
	// 	let matchingLanguage = monacoLanguages.find(
	// 		(monacoLanguage) => monacoLanguage.value === language,
	// 	);
	// 	matchingLanguage = matchingLanguage
	// 		? matchingLanguage
	// 		: monacoLanguages.find(
	// 				(monacoLanguage) => monacoLanguage.value === secondBest?.language,
	// 			);
	// 	matchingLanguage = matchingLanguage
	// 		? matchingLanguage
	// 		: monacoLanguages.find(
	// 				(monacoLanguage) => monacoLanguage.value === "plaintext",
	// 			);
	...
	return (
		<div className="h-screen w-screen flex flex-col">
			...
			<div className="flex flex-row w-full justify-end bg-darkgray border-t-[1px] border-lightgray border-solid">
				...
				<button
					type="button"
					// onClick={sendTextBack}
					className="bg-blue-500 text-white text-sm py-2 basis-24 font-semibold text-center shrink-0"
				>
					SAVE
				</button>
			</div>
